/** 
 * the directive representing every coupon in the customer's purchased coupons page
 * @author Yuval Maayan
 * @version 1.0
 * */

couponApp.directive('purchasedCoupondiv',function(){
	return {
		retstrict: 'A',
		scope:{
			coupon:'=',
...
/**a function that shows the more info window */
		...
		templateUrl:'WebContent/javascript/templates/purchasedCoupondiv.html'
	}
});
